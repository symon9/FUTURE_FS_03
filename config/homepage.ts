...
// We can define a type for our scenes right here or import a shared one.
interface Scene {
  id: string;
  text: string;
  imageSrc: string;
...
export const galleryScenes: Scene[] = [
  {
    ...
    imageSrc:
      "https://drive.google.com/uc?id=1FFC3uvx4jQd-D1EDpQ853kGiaHe5l-XY",
  ...
  },
  {
    ...
    imageSrc:
      "https://drive.google.com/uc?id=18l0NZ84fu-foUHlvuPFugH3aX44QOqtU",
  ...
  },
  {
    ...
    imageSrc:
      "https://drive.google.com/uc?id=1aVqwJdLVqyr1zzCApqfHMycmBFD93hod",
